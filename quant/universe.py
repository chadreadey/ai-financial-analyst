...
LIQUID_100 = [
    # Technology (12)
    "AAPL", "MSFT", "NVDA", "GOOGL", "META", "AVGO", "CRM", "ORCL",
    "ADBE", "CSCO", "AMD", "INTC",
    # Healthcare (10)
    "JNJ", "UNH", "PFE", "ABBV", "MRK", "LLY", "TMO", "ABT",
    "BMY", "AMGN",
    # Financials (10)
    "JPM", "BAC", "GS", "MS", "BRK-B", "WFC", "C", "BLK",
    "SCHW", "AXP",
...
LIQUID_200 = LIQUID_100 + [
    # Technology
    "NOW", "INTU", "PANW", "SNPS", "CDNS", "KLAC", "AMAT", "LRCX",
    "MRVL", "ADI", "FTNT", "WDAY",
    # Healthcare
    "ISRG", "GILD", "VRTX", "REGN", "ZTS", "SYK", "BDX", "MDT",
    "EW", "DXCM", "IQV", "HCA",
    # Financials
    "ICE", "CME", "AON", "MCO", "SPGI", "TFC", "USB", "PNC",
    "MET", "AIG", "PRU", "TRV",
    # Consumer Discretionary
    "ROST", "ORLY", "AZO", "LULU", "DHI", "LEN", "GM", "F",
    "YUM", "DPZ", "MAR", "HLT",
    # Consumer Staples
    "EL", "KHC", "GIS", "SJM", "HSY", "MO", "STZ", "KMB",
    # Industrials
    "WM", "ETN", "ITW", "EMR", "FDX", "CSX", "NSC", "PCAR",
    "GD", "NOC", "TT", "CTAS",
    # Energy
    "OXY", "DVN", "HAL", "FANG", "BKR", "HES", "KMI", "WMB",
    # Materials
    "DD", "DOW", "NUE", "BALL", "VMC", "MLM", "PPG", "ALB",
    # Utilities
    "XEL", "WEC", "ES", "AEE", "CMS", "AWK", "ED", "EXC",
    # Real Estate
    "O", "DLR", "WELL", "AVB", "EQR", "VTR", "ARE", "MAA",
    # Communication Services
    "CHTR", "TMUS", "TTWO", "EA", "LYV", "MTCH", "WBD", "PARA",
]
...
TICKER_SECTOR = {
    ...
    "INTC": "Technology", "NOW": "Technology", "INTU": "Technology",
    "PANW": "Technology", "SNPS": "Technology", "CDNS": "Technology",
    "KLAC": "Technology", "AMAT": "Technology", "LRCX": "Technology",
    "MRVL": "Technology", "ADI": "Technology", "FTNT": "Technology",
    "WDAY": "Technology",
    # Healthcare
    ...
    "SYK": "Healthcare", "BDX": "Healthcare", "MDT": "Healthcare",
    "EW": "Healthcare", "DXCM": "Healthcare", "IQV": "Healthcare",
    "HCA": "Healthcare",
    # Financials
    "JPM": "Financials", "BAC": "Financials", "GS": "Financials",
    "MS": "Financials", "BRK-B": "Financials", "WFC": "Financials",
    "C": "Financials", "BLK": "Financials", "SCHW": "Financials",
    "AXP": "Financials", "ICE": "Financials", "CME": "Financials",
    "AON": "Financials", "MCO": "Financials", "SPGI": "Financials",
    "TFC": "Financials", "USB": "Financials", "PNC": "Financials",
    "MET": "Financials", "AIG": "Financials", "PRU": "Financials",
    "TRV": "Financials",
    # Consumer Discretionary
    ...
    "GIS": "Consumer Staples", "SJM": "Consumer Staples",
    "HSY": "Consumer Staples", "MO": "Consumer Staples",
    "STZ": "Consumer Staples", "KMB": "Consumer Staples",
    # Industrials
    ...
    "MMM": "Industrials", "WM": "Industrials", "ETN": "Industrials",
    "ITW": "Industrials", "EMR": "Industrials", "FDX": "Industrials",
    "CSX": "Industrials", "NSC": "Industrials", "PCAR": "Industrials",
    "GD": "Industrials", "NOC": "Industrials", "TT": "Industrials",
    "CTAS": "Industrials",
    # Energy
    ...
    "BKR": "Energy", "HES": "Energy", "KMI": "Energy",
    "WMB": "Energy",
    # Materials
    "LIN": "Materials", "APD": "Materials", "SHW": "Materials",
    "FCX": "Materials", "NEM": "Materials", "ECL": "Materials",
    "DD": "Materials", "DOW": "Materials", "NUE": "Materials",
    "BALL": "Materials", "VMC": "Materials", "MLM": "Materials",
    "PPG": "Materials", "ALB": "Materials",
    # Utilities
    "NEE": "Utilities", "DUK": "Utilities", "SO": "Utilities",
    "D": "Utilities", "AEP": "Utilities", "SRE": "Utilities",
    "XEL": "Utilities", "WEC": "Utilities", "ES": "Utilities",
    "AEE": "Utilities", "CMS": "Utilities", "AWK": "Utilities",
    "ED": "Utilities", "EXC": "Utilities",
    # Real Estate
    ...
    "ARE": "Real Estate", "MAA": "Real Estate",
    # Communication Services
    ...
    "EA": "Communication Services", "LYV": "Communication Services",
